...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, radii, t_out, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, radii, t_out

    @staticmethod
    def backward(ctx, grad_out_color, grad_t_out, _):
